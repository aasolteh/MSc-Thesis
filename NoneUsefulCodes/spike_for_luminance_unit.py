...
for sessNum in range(len(sessions.index.values)):
    ...
    sessionPath = '/home/amirali/Desktop/Thesis/Codes/unit_data/Data/HiLoLuminance/' + str(thisSessionNum)
    if not os.path.exists(sessionPath):
        os.makedirs(sessionPath)
    sessionDataPath = '/home/amirali/Desktop/Thesis/Codes/unit_data/Data/HiLoLuminance/' + str(thisSessionNum) + '/'
    ...
    lowDataFrame   = wholeDataFrame[wholeDataFrame.LLuminance == 1].name
    highDataFrame  = wholeDataFrame[wholeDataFrame.HLuminance == 1].name
